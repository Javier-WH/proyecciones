...
import FrozenSections from "../../backEnd/dataBase/models/schedule/frozenSections.js";
import fs from "fs";
...
async function runMigration() {
  try {
    ...
    try {
      ...
      await FrozenSections.destroy({ where: { proyection_id: proyectionId }, transaction });
