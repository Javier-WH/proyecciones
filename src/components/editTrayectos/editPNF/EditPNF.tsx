...
export default function EditPNF() {
  ...
  return <div>
    <EditPNFModal programa={activePNF} setprograma={setActivePNF} isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} fetchPnf={fetchPnf} />
    ...
    <div style={{
      ...
      <Button type="primary" onClick={() => setIsModalOpen(true)}>Agregar Programa</Button>
    </div>
  </div>
}