...
export default function Profiles() {
  ...
  }, [selectedPerfil, selectedSubject])
  ...
  return <div>
    ...
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", columnGap: "1rem", width: "100%", maxWidth: "500px", minWidth: "300px", flexWrap: "wrap", margin: "50px auto" }}>
      <Button type="primary" style={{ flex: 1 }}>Crear Perfil</Button>
      <Button type="dashed"  style={{ flex: 1 }}>Eliminar Perfil</Button>
    </div>
    <div style={{ display: "flex", columnGap: "1rem", width: "100%", maxWidth: "1000px", minWidth: "500px", flexWrap: "wrap", margin: "50px auto" }}>
